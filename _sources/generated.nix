...
}:
{
  ...
  gemini-cli = {
    ...
    version = "v0.39.1";
    src = fetchurl {
      url = "https://github.com/google-gemini/gemini-cli/releases/download/v0.39.1/gemini-cli-bundle.zip";
      sha256 = "sha256-JWqnHcAQjOagTGErHkdKzgU2Dwpe+z4j2bNOwNMoMhw=";
    };
  };
  googlesans-code = {
