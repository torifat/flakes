...
}:
{
  awakened-poe-trade = {
    ...
    version = "3.29.106";
    src = fetchurl {
      url = "https://github.com/SnosMe/awakened-poe-trade/releases/download/v3.29.106/Awakened-PoE-Trade-3.29.106-universal.dmg";
      sha256 = "sha256-EmU609BC6Nkgqfo3XvSp39FYe6/2qDujfmn1ju50bEY=";
    };
  };
