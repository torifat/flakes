...
}:
{
  ...
  prek = {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-oBrru3/OvrHLXAdOGj0AzFGig6W9iZD85nZcXTUKxgI=";
    };
  };
  prek-x86_64-linux = {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-xGfyGcKo4pl2CIU8zt80nzAz0lCG868ee6v5aKue3S0=";
    };
  };
  pvetui = {
    pname = "pvetui";
  ...
  worktrunk = {
    ...
    version = "v0.45.0";
    src = fetchurl {
      url = "https://github.com/max-sixty/worktrunk/releases/download/v0.45.0/worktrunk-aarch64-apple-darwin.tar.xz";
      sha256 = "sha256-Y+8lVniCZd0JRDPk8d15cKzehjwxRAcNiU4h8YeLWwM=";
    };
  };
}
